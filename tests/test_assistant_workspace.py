...
class AssistantWorkspaceTests(unittest.TestCase):
    ...
    def test_external_confirmation_reject_reuse_and_reset_follow_provider_scope(self) -> None:
        alternate = self.client.post("/api/v2/settings/providers", json={
            "id": "opencode-alt",
            "provider_type": "opencode",
            "display_name": "OpenCode alternate",
            "base_url": "http://127.0.0.1:4097",
            "model_settings": {"orchestrator_model": "opencode-go/gpt-5.6-luna"},
        ...
        switched_run_id = self._start_run(
            ...
            conversation_id,
            provider_profile_id="opencode-alt",
