...
STORYBOARD_SCENE_LEDGER_SCHEMA = {
    ...
    "properties": {
        ...
        "characterDesire": {"type": "string"},
        "primaryObstacle": {"type": "string"},
    ...
    "required": [
        ...
        "sceneGoal", "characterDesire", "primaryObstacle", "observableAction",
        "stateChange", "turn", "entryState", "exitState",
    ],
...
STORYBOARD_OUTPUT_SCHEMA = {
    ...
    "properties": {
        ...
        "sourceScriptPolicy": {"type": "string"},
        ...
        "ruleProfile": {"type": "string"},
        "ruleProfileVersion": {"type": "string"},
        "ruleModules": {"type": "object", "additionalProperties": True},
        "ruleSources": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
        "autoReview": {"type": "object", "additionalProperties": True},
        "handoffCompatibility": {"type": "object", "additionalProperties": True},
        ...
        "shots": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "environmentPressure": {"type": "string"},
                ...
                "required": ["id", "scene", "duration", "purpose", "size", "camera", "action", "visibleEvent", "eventConsequence", "sourceBeatIds", "subjectFocus", "performance", "blocking", "coverageRole", "environmentPressure", "microAction", "spatialGeography", "materialEvidence", "lightingCausality", "cameraExecution", "continuity", "assetRequirements", "seedancePlan"],
                "additionalProperties": True,
            },
        },
        ...
        "creativeAdditions": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
        "needsConfirmation": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
...
PROMPT_PACK_SCHEMA = {
    "type": "object",
    "properties": {
        "templateSelection": {"type": "object", "additionalProperties": True},
        "subjectTask": {"type": "string"},
        "compositionLayout": {"type": "string"},
        "visualStyleMaterials": {"type": "string"},
        "textLabels": {"type": "string"},
        "aspectRatioOutput": {"type": "object", "additionalProperties": True},
        "constraintsNegative": {"type": "array", "items": {"type": "string"}},
        "referenceRoles": {"type": "array", "items": {"type": "object", "additionalProperties": True}},
        "actionContinuity": {"type": "string"},
    },
    "required": [
        "templateSelection", "subjectTask", "compositionLayout",
        "visualStyleMaterials", "textLabels", "aspectRatioOutput", "constraintsNegative", "referenceRoles",
    ],
    "additionalProperties": False,
}
    ...
    "properties": {
        "assets": {
            ...
            "items": {
                ...
                "required": ["id", "assetClass", "name", "priority", "required", "targetSkill", "relevantShots", "prompt", "promptPack"],
                "additionalProperties": False,
            },
        },
        "fusionPlans": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "checks": {
                        "type": "object",
                        "properties": {
                            "style_library": {"type": "boolean"},
                            "prompt_blocks": {"type": "boolean"},
                            "asset_scope": {"type": "boolean"},
                            "geometry": {"type": "boolean"},
                            "copy_boundary": {"type": "boolean"},
                            "continuity": {"type": "boolean"},
                        },
                        "required": ["style_library", "prompt_blocks", "asset_scope", "geometry", "copy_boundary", "continuity"],
                        "additionalProperties": True,
                    },
                },
